Module ModuleSMM
    ...
    "버섯", "도넛블럭", "구름블럭", "음표블럭", "파이어바", "가시돌이", "깃대블럭", "깃대", "하잉바", "히든블럭",
    "김수한무", "김수한무구름", "매그넘킬러", "1UP버섯", "파이어플라워", "슈퍼스타", "해골리프트", "시작 벽돌", "시작 화살표",
    "마귀", "가시하잉바", "유령", "쿠파 피에로", "가시 블럭", "거대버섯", "신발굼바", "와르르", "대포", "징오징오", "성의 다리",
    ...
    "버섯", "도넛블럭", "구름블럭", "음표블럭", "파이어바", "가시돌이", "깃대블럭", "깃대", "하잉바", "히든블럭",
    "김수한무", "김수한무구름", "매그넘킬러", "1UP버섯", "파이어플라워", "슈퍼스타", "해골리프트", "시작 벽돌", "시작 화살표",
    "마귀", "가시하잉바", "유령", "쿠파 피에로", "가시 블럭", "너구리마리오", "신발굼바", "와르르", "대포", "징오징오", "성의 다리",
    "뛰용뛰용", "폴찍폴찍", "꽃충이", "컨베이어벨트", "버너", "문", "뽀꾸뽀꾸", "블랙뻐끔", "뚜", "궤도", "버블",
    "멍멍이", "쿠파", "얼음블럭", "덩굴", "벌", "화살표", "일방통행", "그라인더", "Player", "10/30/50동전", "플랫폼",
    ...
    "버섯", "도넛블럭", "구름블럭", "음표블럭", "파이어바", "가시돌이", "깃대블럭", "깃대", "하잉바", "히든블럭",
    "김수한무", "김수한무구름", "매그넘킬러", "1UP버섯", "파이어플라워", "슈퍼스타", "해골리프트", "시작 벽돌", "시작 화살표",
    "마귀", "가시하잉바", "유령", "쿠파 피에로", "가시 블럭", "망토마리오", "요시", "와르르", "대포", "징오징오", "성의 다리",
    "뛰용뛰용", "폴찍폴찍", "꽃충이", "컨베이어벨트", "버너", "문", "뽀꾸뽀꾸", "블랙뻐끔", "뚜", "궤도", "버블",
    "멍멍이", "쿠파", "얼음블럭", "덩굴", "벌", "화살표", "일방통행", "그라인더", "Player", "10/30/50동전", "플랫폼",
    ...
    "버섯", "도넛블럭", "구름블럭", "음표블럭", "파이어바", "가시돌이", "깃대블럭", "깃대", "하잉바", "히든블럭",
    "김수한무", "김수한무구름", "매그넘킬러", "1UP버섯", "파이어플라워", "슈퍼스타", "해골리프트", "시작 벽돌", "시작 화살표",
    "마귀", "가시하잉바", "유령", "쿠파 피에로", "가시 블럭", "프로펠러버섯", "요시", "와르르", "대포", "징오징오", "성의 다리",
    "뛰용뛰용", "폴찍폴찍", "꽃충이", "컨베이어벨트", "버너", "문", "뽀꾸뽀꾸", "블랙뻐끔", "뚜", "궤도", "버블",
    "멍멍이", "쿠파", "얼음블럭", "덩굴", "벌", "화살표", "일방통행", "그라인더", "Player", "10/30/50동전", "플랫폼",
    ...
    "버섯", "도넛블럭", "구름블럭", "음표블럭", "파이어바", "가시돌이", "깃대블럭", "깃대", "하잉바", "히든블럭",
    "김수한무", "김수한무구름", "매그넘킬러", "1UP버섯", "파이어플라워", "슈퍼스타", "해골리프트", "시작 벽돌", "시작 화살표",
    "마귀", "가시하잉바", "유령", "쿠파 피에로", "가시 블럭", "슈퍼벨", "신발굼바", "와르르", "대포", "징오징오", "성의 다리",
